    ...
    <div className="md:w-4/12 my-4">
      <fieldset className="border-gray-600 border rounded-lg px-5 shadow-xl mb-10">
        ...
        <form action="" className="px-15 m7-20">
          ...
          <button
            type="button"
            className="w-full my-5 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"
          >
            Enviar
          </button>
        </form>
      </fieldset>
      <div className="border   px-2 md:px-4 pb-10">
        ...
        <p className="text-gray-600 text-left md:text-xl">Establecemos las características de los artículos</p>
